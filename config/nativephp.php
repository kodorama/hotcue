...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.kodorama.hotcue'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'HotCue'),

    /**
     * The copyright notice for your application.
     */
    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', '© ' . date('Y') . ' HotCue'),

    /**
     * The description of your application.
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'macOS menu bar OBS controller — trigger scene switches, mute, and more via global hotkeys'),
